@php
    ...
    $matrixRows = [
        ...
        ['domain' => __('roles_hub.help_dom_offerings'), 'sa' => $full, 'adm' => $read, 'aca' => $full, 'fin' => $read, 'ins' => $own, 'ta' => $own, 'stu' => $read],
        ...
        ['domain' => __('roles_hub.help_dom_enrollment'), 'sa' => $full, 'adm' => $full, 'aca' => $read, 'fin' => $none, 'ins' => $own, 'ta' => $none, 'stu' => $own],
        ...
        ['domain' => __('roles_hub.help_dom_live'), 'sa' => $full, 'adm' => $full, 'aca' => $full, 'fin' => $none, 'ins' => $own, 'ta' => $own, 'stu' => $none],
        ['domain' => __('roles_hub.help_dom_announcements'), 'sa' => $full, 'adm' => $full, 'aca' => $full, 'fin' => $read, 'ins' => $own, 'ta' => $own, 'stu' => $own],
