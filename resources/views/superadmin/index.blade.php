...
<div class="sa-console animate-in">
    ...
    <aside class="sa-roadmap app-card mt-4" aria-label="{{ __('superadmin.roadmap_title') }}">
        ...
        <ul class="sa-roadmap-list mb-0">
            ...
            <li class="is-done"><span class="sa-phase">SA3</span> {{ __('superadmin.roadmap_sa3_done') }}</li>
            <li class="is-done"><span class="sa-phase">SA4</span> {{ __('superadmin.roadmap_sa4_done') }}</li>
            <li class="is-done"><span class="sa-phase">SA5</span> {{ __('superadmin.roadmap_sa5_done') }}</li>
