...
@section('content')
        <div class="card border-0 auth-card">
            <div class="card-body p-4 p-md-5">
                <h1 class="h3 spims-title mb-2"><span class="spims-heading-icon-wrap" aria-hidden="true"><x-icon name="lock" class="spims-heading-icon" /></span><span>{{ __('ui.reset_password') }}</span></h1>
