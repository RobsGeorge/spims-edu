...
<form method="GET" class="row g-2 mb-3">
    <div class="col-12 col-md-2"><input name="type" value="{{ $filters['type'] ?? '' }}" class="form-control" placeholder="{{ __('communications.filter_type') }}"></div>
    <div class="col-12 col-md-2"><input name="channel" value="{{ $filters['channel'] ?? '' }}" class="form-control" placeholder="{{ __('communications.filter_channel') }}"></div>
    <div class="col-12 col-md-2"><input name="status" value="{{ $filters['status'] ?? '' }}" class="form-control" placeholder="{{ __('communications.filter_status') }}"></div>
    <div class="col-12 col-md-2"><input name="locale" value="{{ $filters['locale'] ?? '' }}" class="form-control" placeholder="{{ __('communications.filter_locale') }}"></div>
    <div class="col-12 col-md-2"><button class="btn btn-outline-primary w-100">{{ __('communications.apply_filters') }}</button></div>
