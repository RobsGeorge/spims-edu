...
@endphp
<section id="standing" class="card border-0 shadow-sm app-card mb-4">
    <div class="card-body">
        <h2 class="h5 spims-title mb-2">{{ __('reports.program_thresholds_title') }}</h2>
        <p class="text-muted-theme mb-2">{{ __('reports.program_thresholds_help') }}</p>
        <p class="text-muted-theme mb-2">{{ __('reports.program_thresholds_inherited', [
            'good_min' => $schoolThresholds['good_min'],
            'suspension_below' => $schoolThresholds['suspension_below'],
        ]) }}</p>
        <p class="text-muted-theme mb-3">{{ __('reports.program_thresholds_current', ['source' => $sourceLabel]) }}</p>
