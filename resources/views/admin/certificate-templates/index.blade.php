...
<form method="POST" action="{{ route('admin.certificate-templates.store') }}" class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body row g-2">
        ...
        <div class="col-12 col-md-7"><input name="title" class="form-control" required placeholder="{{ __('completion.template_title') }}"></div>
        ...
        <div class="col-12 col-md-3"><button class="btn btn-primary">{{ __('completion.save_template') }}</button></div>
    </div>
</form>
...
<form method="GET" action="{{ route('admin.certificate-templates.preview') }}" class="mb-4">
    <div class="row g-2">
        ...
        <div class="col-12 col-md-2"><button class="btn btn-outline-secondary">{{ __('completion.preview') }}</button></div>
    </div>
</form>
