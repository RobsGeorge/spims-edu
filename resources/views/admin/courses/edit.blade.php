...
<form method="POST" action="{{ route('admin.courses.update', $course) }}">
    ...
    <x-card variant="panel"><div class="row g-3">
        ...
        <div class="col-12 col-md-3"><label class="form-label">{{ __('academics.credits') }}</label><input type="number" name="credit_hours" class="form-control" value="{{ old('credit_hours', $course->credit_hours) }}" required></div>
        <div class="col-12 col-md-3"><label class="form-label">{{ __('academics.price_usd') }}</label><input type="number" name="default_price_usd" class="form-control" value="{{ old('default_price_usd', $course->default_price_usd) }}"></div>
        <div class="col-12 col-md-3"><label class="form-label">{{ __('academics.price_egp') }}</label><input type="number" name="default_price_egp" class="form-control" value="{{ old('default_price_egp', $course->default_price_egp) }}"></div>
        <div class="col-12 col-md-3">
        ...
        <div class="col-12 col-md-3"><label class="form-label">{{ __('academics.passing_threshold') }}</label><input type="number" step="0.01" name="passing_threshold" class="form-control" value="{{ old('passing_threshold', $course->passing_threshold) }}"></div>
