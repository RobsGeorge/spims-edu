...
<div class="d-flex justify-content-between align-items-start">
    <div>
        ...
        <p class="spims-text-dim">{{ __('academics.credits') }}: {{ $course->credit_hours }} · {{ __('academics.interest') }}: {{ $course->interestFlags->count() }} · {{ $course->active ? __('academics.active') : __('academics.inactive') }}</p>
    </div>
