...
class ImportCourseResultTest extends TestCase
{
    ...
    public function committing_a_course_result_creates_a_shadow_course_and_offering_on_no_match(): void
    {
        ...
        $batch = $service->createFromUpload($actor, $source, $csv, null, ImportEntityType::CourseResult);
    ...
    public function a_second_import_of_the_same_row_updates_instead_of_duplicating(): void
    {
        ...
        $batch1 = $service->createFromUpload($actor, $source, $csv1, null, ImportEntityType::CourseResult);
        ...
        $batch2 = $service->createFromUpload($actor, $source, $csv2, null, ImportEntityType::CourseResult);
