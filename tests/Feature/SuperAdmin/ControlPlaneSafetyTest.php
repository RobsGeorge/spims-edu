...
class ControlPlaneSafetyTest extends TestCase
{
    ...
    public function upcoming_control_plane_tiles_are_hidden_until_routed(): void
    {
        ...
        $this->assertTrue(\Illuminate\Support\Facades\Route::has('superadmin.integrations'));
        ...
        $this->assertTrue($urls->contains(fn ($url) => str_contains((string) $url, '/superadmin/integrations')));
    }
}
