...
class NavigationHub
{
    ...
    public static function bottomNav(?User $user): array
    {
        ...
        $items = [
            ...
            ['label' => __('hubs.nav_learning'), 'route' => 'hubs.learning', 'icon' => 'bi-book-half', 'active' => request()->routeIs('hubs.learning') || request()->routeIs('courses.*') || request()->routeIs('student.surveys.*')],
            $third,
