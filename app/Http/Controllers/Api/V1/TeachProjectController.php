...
class TeachProjectController extends Controller
{
    ...
    public function teams(
        ...
        return response()->json([
            ...
            'confirmation' => $confirmation->issue($request->user(), 'projects.announce', $projectAssessment->id),
        ]);
    }
    ...
    public function announce(
        ...
        $confirmation->consume($request->user(), 'projects.announce', $projectAssessment->id, $data['confirmation']);
