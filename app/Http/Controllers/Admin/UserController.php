...
class UserController extends Controller
{
    ...
    public function show(
        ...
        return view('admin.users.show', array_merge($dossier, [
            ...
            'held' => $enrollment->hasManualFinancialHold($user),
            'offerings' => CourseOffering::query()->with(['course', 'semester'])->latest()->get(),
    ...
    {
        return $this->revokeRole($request, $user, $role, $service);
    }
