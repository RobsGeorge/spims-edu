...
return [
    ...
    'guide_override_body' => 'Skips the checks a self-service registration goes through — offering-open status, financial and advising holds, the registration window, and prerequisites. Seat capacity is still respected; a full offering still waitlists.',
    'guide_audit_body' => "Marks the enrollment as audit — no grade is computed and it never counts toward a program's completion requirement.",
    'guide_hold_body' => 'Blocks the student from self-service registration until released. An override-register above still succeeds while a hold is on.',
