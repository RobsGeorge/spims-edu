...
return [
    ...
    'guide_issue_body' => 'ينشئ الشهادة ورمز التحقق (QR) الخاص بها فورًا — تصبح مرئية للعامة عبر ‎/verify‎ فور الإرسال.',
    'guide_regenerate_body' => 'يصدر رقمًا تسلسليًا ورمز QR جديدين فورًا — يتوقف رمز QR القديم عن التحقق. يُرفض لشهادة مستوردة من نظام قديم؛ فرقمها التسلسلي الأصلي هو سجل الإصدار.',
    ...
    'historical_download_banner' => 'سجل تاريخي — نسخة للأرشيف فقط',
    'historical_download_notice' => 'لم تُصدر هذه الوثيقة عن طريق SPIMS. هي نسخة طبق الأصل لسجل مستورد من نظام سابق، تُقدَّم للرجوع إليها فحسب.',
];
