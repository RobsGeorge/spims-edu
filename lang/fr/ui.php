...
return [
    ...
    'auth_help_verify_reset' => "Saisissez le code à six chiffres envoyé à votre adresse e-mail.",
    'auth_help_new_password' => "Choisissez un mot de passe d'au moins huit caractères.",
    'auth_help_set_password' => "Choisissez un mot de passe d'au moins huit caractères.",
    'auth_back_to_login' => 'Retour à la connexion',
    'verify_reset_title' => 'Vérifiez votre e-mail',
